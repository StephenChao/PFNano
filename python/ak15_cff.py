...
def setupAK15(process, runOnMC=False, path=None, runParticleNet=False, runParticleNetMD=True):
    ...
    if runParticleNetMD:
        process.pfParticleNetTagInfosAK15ParticleNet.jet_radius = 1.5
        process.pfMassDecorrelatedParticleNetJetTagsAK15ParticleNet.preprocess_json = 'PhysicsTools/PFNano/data/ParticleNet-MD/ak15/V02d/preprocess.json'
        process.pfMassDecorrelatedParticleNetJetTagsAK15ParticleNet.model_path = 'PhysicsTools/PFNano/data/ParticleNet-MD/ak15/V02d/particle-net.onnx'
